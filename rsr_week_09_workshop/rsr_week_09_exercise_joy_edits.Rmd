...
**Question:** Which variables are truly numeric?
...
**Question:** Interpret `sexMale` in the multiple model output. Use the phrase "holding the other predictors constant" in your answer.
...
**Question:** In the simple model, the age coefficient was 0.447 and looked clearly associated with depression score. What changed in the multiple model?
...
**Question:** Based on the regression results, which variables/levels are significantly associated with higher depression scores?
