...
Fill in the blanks in the code below to load the packages we will need: `readxl`, `tidyverse`, `gt`, `gtsummary`, `here`, and `janitor`.
...
The code below turns your summaries and tests into a publication-style table that more closely matches the paper.
...
Then write a prompt that includes the object name, the output from the glimpse function showing the structure of the data, the current `gt` code from the `render-table` chunk above, and the package you want to use.
